...
import nues_servi_5 from '../../images/nues_servi_5.png'
import nues_servi_6 from '../../images/nues_servi_6.png'
import andino_nor from '../../images/andino_nor.png'
import image_8_3 from '../../images/image 8-3.jpg'
import logo_andikem from '../../images/Andikem logo bg.png'
...
function AndikemsitioComp(props) {
    return (
        <>
            <section className='andikem_bg bg_res'>
                <div className="container">
                    <div className="row">
                        <div className="col pt-5 align-items-end d-flex">
                            <img src={logo_andikem} alt="sitio_bg" className='andikem_sit_logo me-3'/>
                            <img src={props.flag} alt="sitio_bg" className='mb-2 andisitio_flag'/>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div className="container py-5">
                ...
                <div className="row align-items-center">
                    ...
                    <div className='col-md-6 text-center'>
                        <img src={image_8_3} alt="image_8" className='img_rad' />
                    </div>
                </div>
            </div>
            <div className="container">
                ...
                <div className="row justify-content-around">
                    <div className="col-md-5 mb-4">
                        <div className="nues_ser_text nuestros_services_box">
                            <img src={nues_servi_5} alt="nues_servi_1" className='mb-4' width="100%" />
                    ...
                    <div className="col-md-5 mb-4">
                        <div className="nues_ser_text nuestros_services_box">
                            <img src={nues_servi_6} alt="nues_servi_2" className='mb-4' width="100%" />
...
export default AndikemsitioComp

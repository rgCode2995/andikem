...
import image_8_1 from '../../images/image 8-1.jpg'
import logo_anditerminals from '../../images/empresas_f_3.png'
import andishipping_nor from '../../images/andishipping_nor.png'
import termi_color from '../../images/termi_color.png'
import { Link } from 'react-router-dom'



function Anditerminals() {
    return (
        <>
            <section className='anditerminals_bg bg_res'>
                <div className="container">
                    <div className="row">
                        <div className="col pt-5">
                            <img src={logo_anditerminals} alt="sitio_bg"/>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div className="container py-5">
                ...
                <div className="row align-items-center">
                    ...
                    <div className='col-md-6 text-center'>
                        <img src={image_8_1} alt="image_8" className='img_rad' />
                    </div>
                </div>
            </div>
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 mb-4">
                        <Link to="/upwork/andikem-react/wp-content/reactpress/apps/andikem/anditerminals">
                            <img src={termi_color} alt="termi_nor" width="100%" />
                        </Link>
                    </div>
                </div>
            </div>
